...
const LandingPage: React.FC = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="space-y-4 mb-12 animate-in slide-in-from-bottom-4 duration-1000 delay-300">
            <p className="text-lg text-slate-500">
             Create personalized roadmaps for career, skills, courses, and projects
            </p>
          </div>
  ...
  <div className="text-center">
    <div className="w-20 h-20 mx-auto mb-6 bg-blue-500 rounded-3xl flex items-center justify-center">
      <Briefcase className="w-10 h-10 text-white" />
    </div>
    <h3 className="font-bold text-lg">Career Roadmap</h3>
    <p className="text-sm text-slate-600">
      Plan your career with step-by-step roadmap
    </p>
  </div>

  <div className="text-center">
    <div className="w-20 h-20 mx-auto mb-6 bg-green-500 rounded-3xl flex items-center justify-center">
      <Target className="w-10 h-10 text-white" />
    </div>
    <h3 className="font-bold text-lg">Skill Learning</h3>
    <p className="text-sm text-slate-600">
      Learn skills with structured phases
    </p>
  </div>

  <div className="text-center">
    <div className="w-20 h-20 mx-auto mb-6 bg-purple-500 rounded-3xl flex items-center justify-center">
      <CheckCircle className="w-10 h-10 text-white" />
    </div>
    <h3 className="font-bold text-lg">Course Planner</h3>
    <p className="text-sm text-slate-600">
      Follow course roadmap step-by-step
    </p>
  </div>
          ...
          {/* Why Choose RoadmapAI Section */}
          <div className="mt-24 animate-in slide-in-from-bottom-4 duration-1000 delay-1400">
            <h2 className="text-4xl font-bold text-slate-800 mb-4">Why Choose RoadmapAI?</h2>
          ...
          <div className="mt-24 animate-in slide-in-from-bottom-4 duration-1000 delay-1600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20 hover:scale-105 transition-all duration-300 group">
                ...
                <p className="text-slate-700 italic leading-relaxed">"RoadmapAI transformed how I plan my learning goals. The AI-generated roadmaps are incredibly detailed and practical. I've completed 3 major skill upgrades this year!"</p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20 hover:scale-105 transition-all duration-300 group">
                ...
                <p className="text-slate-700 italic leading-relaxed">""I use RoadmapAI to create learning and career roadmaps for my students. The visual steps make it easy to track progress.""</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-24 animate-in slide-in-from-bottom-4 duration-1000 delay-1700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="text-center group">
                ...
                <p className="text-slate-600 leading-relaxed">Simply tell us what you want to achieve. Whether it's a career goal, learning a skill, completing a course, or building a project.</p>
              </div>
          ...
          <div className="mt-24 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-3xl p-12 text-white animate-in slide-in-from-bottom-4 duration-1000 delay-1800">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Join thousands of users who've already achieved their dreams with RoadmapAI. Start your journey today!
            </p>
