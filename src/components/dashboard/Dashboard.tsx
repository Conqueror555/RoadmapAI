...
import { Plus, Calendar, Briefcase, Trash2, AlertCircle, Search, Filter, ChevronDown, ArrowLeft, ArrowRight, Target, Code, CheckCircle } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  { value: 'career', label: 'Career Roadmap', icon: Briefcase },
  { value: 'skill', label: 'Skill Planner', icon: Target },
  { value: 'course', label: 'Course Planner', icon: CheckCircle },
  { value: 'project', label: 'Project Roadmap', icon: Code },
];
