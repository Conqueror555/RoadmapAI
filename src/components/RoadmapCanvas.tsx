      ...
      return (
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="text-center max-w-2xl px-8">
            ...
            <h3 className="text-4xl font-bold text-slate-800 mb-6">Welcome to RoadmapAI</h3>
            <p className="text-slate-600 text-xl mb-4">Your AI-powered career roadmap generator</p>
            <p className="text-slate-500 text-lg mb-8">Create career, skill, course, and project roadmaps with AI guidance</p>
            </div>
        </div>
      );
    }
