...
const CallToActionBanner: React.FC = () => {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl sm:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Create AI-powered career roadmaps to plan your future, learn skills, and achieve your goals step by step.
          </p>
        </div>
  ...
  <div className="text-center">
    ...
    <div className="text-blue-200">Powered Roadmaps</div>
  </div>
  <div className="text-center">
    <div className="text-4xl font-bold text-white mb-2">Career</div>
    <div className="text-blue-200">Planning</div>
  </div>
  <div className="text-center">
    <div className="text-4xl font-bold text-white mb-2">Skills</div>
